...
public class Main {
    public static void main(String[] args) {
        ...
        if (Wh > 0) {
            System.out.println("The Watt Hours of a Fully Charged " + mAh + "mAh, " + CellCount + " cell LiPo (" + PackVoltage + " Volts) is " + Wh + " Watt Hours");
            System.out.println("------");
        ...
        if (response3.equals("yes")) {
            ...
            System.out.println("------");
            if (Wh > 0) {
                System.out.println("The Watt Hours of the first battery with a fully charged " + mAh + "mAh, " + CellCount + " cell LiPo (" + PackVoltage + " Volts) is " + Wh + " Watt Hours");
                System.out.println("------");
                if (Watts > 0) {
            ...
            System.out.println("------");
            if (Wh1 > 0) {
                System.out.println("The Watt Hours of the seccond battery with a fully charged  " + mAh1 + "mAh, " + CellCount1 + " cell LiPo (" + PackVoltage1 + " Volts) is " + Wh1 + " Watt Hours");
                System.out.println("------");
                if (Watts1 > 0) {
